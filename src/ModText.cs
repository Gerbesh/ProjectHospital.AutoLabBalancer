...
namespace ProjectHospital.AutoLabBalancer
{
    internal static class ModText
    {
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            { "RadiologyQueueLine", "Radiology planned: total {0}, CT {1}, MRI {2}, X-ray {3}, USG {4}, angio {5}, other {6}" },
            ...
            { "AnalyticsRadiology", " radiology(total/CT/MRI/Xray/USG/angio/other)=" },
        ...
        private static readonly Dictionary<string, string> Ru = new Dictionary<string, string>
        {
            ...
            { "RadiologyQueueLine", "Радиология назначено: всего {0}, КТ {1}, МРТ {2}, рентген {3}, УЗИ {4}, ангио {5}, другое {6}" },
            ...
            { "AnalyticsRadiology", " радиология(всего/КТ/МРТ/рентген/УЗИ/ангио/другое)=" },
