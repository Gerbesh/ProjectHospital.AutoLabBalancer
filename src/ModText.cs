...
namespace ProjectHospital.AutoLabBalancer
{
    internal static class ModText
    {
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            { "SchedulingEngineLine", "Index: departments {0}, tasks {1}, critical {2}, surgery {3}, meds {4}, transport {5}, free staff {6}/{7}, rebuild {8}ms" },
        ...
        private static readonly Dictionary<string, string> Ru = new Dictionary<string, string>
        {
            ...
            { "SchedulingEngineLine", "Индекс: отделения {0}, задачи {1}, критичные {2}, операции {3}, лекарства {4}, транспорт {5}, свободный персонал {6}/{7}, пересчёт {8}мс" },
