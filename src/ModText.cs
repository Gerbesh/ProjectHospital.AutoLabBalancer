...
namespace ProjectHospital.AutoLabBalancer
{
    internal static class ModText
    {
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            { "EnableSchedulingDispatcherApply", "Let dispatcher drive idle task selection" },
            { "EnableNurseTaskBoard", "Enable nurse task board" },
            { "EnableReservationBroker", "Enable reservation broker" },
            { "EnableRouteRequestThrottle", "Throttle duplicate route requests" },
        ...
        private static readonly Dictionary<string, string> Ru = new Dictionary<string, string>
        {
            ...
            { "EnableSchedulingDispatcherApply", "Разрешить диспетчеру управлять idle-выбором задач" },
            { "EnableNurseTaskBoard", "Включить доску задач медсестёр" },
            { "EnableReservationBroker", "Включить брокер резерваций" },
            { "EnableRouteRequestThrottle", "Троттлить повторные запросы маршрута" },
